					...
					<div class="row">
                        ...
                        <div class="card radius-10">
                            <div class="card-header">
                                ...
                                <form method="POST" action="{{ url('inventory/machine/additem') }}" name="myForm"  class="needs-validation"  onsubmit="return validateForm()">
                                    @csrf
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-action">
                                                    ...
                                                    {{-- <a onclick="return confirm('Are you sure you want to deactvate item?');" href="{{ url('inventory/machine/delete/'.$value->mid) }}"  data-toggle="tooltip" title="Delete!" class="action-icon"> <i class="bx bx-trash"></i></a> --}}
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="{{ url('inventory/machineIetem/update/'.$value->mid) }}" method="POST">
                                                                            @csrf
