...
@section('content')
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Table sales</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
				...
				<!--end breadcrumb-->
				<h6 class="mb-0 text-uppercase">New Table Sale</h6>
				<hr/>
                    <div class="row">
                        <div>
                            <div class="card">
                                <div class="card-header pt-0">
                                    <form method="POST" action="{{ url('inventory/tablesale/additem') }}" name="myForm"  class="needs-validation"  onsubmit="return validateForm()">
                                       @csrf
                                         ...
                                         <script>
                                            ...
                                            $('#item').change(function() {
                                                ...
                                                if (itemID) {
                                                    $.ajax({
                                                        type: "GET",
                                                        url: "{{ url('inventory/getTaleItem') }}?item_id=" + itemID,
                        ...
                        sumInputs();
                           ...
                           <script>
                            function validateSale() {
                              ...
                              else if (ptype == "Credit" && cust == "") {
                              swal('Error', 'Please select a customer', 'warning');
                                  return false;
                              }
                                  else{
                                  return true;
