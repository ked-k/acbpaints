...
@section('title',''.$appName.' | New Deposit')
@section('content')
			<div class="page-content">
				...
				<!--end breadcrumb-->
				<h6 class="mb-0 text-uppercase">Receive Deposit</h6>
				<hr/>
                    <div class="row">
                        <div>
                            <div class="card">
                                <div class="card-header pt-0">
                                    <form method="POST" action="{{ url('inventory/Deposits/add') }}" name="myForm"  class="needs-validation"  onsubmit="return validateForm()">
                                       @csrf
                                        <div class="row mb-2 mt-3">
                                            <input type="hidden" class="form-control" name="reff_number"  readonly value="{{ rand(8960,765555).time() }}">
                                            <div class="col-sm-4">
                                                <div class="text-sm">
                                                <label>Deposting Customer</label>
