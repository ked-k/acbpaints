            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="">
                                    ...
                                    <h4 class="page-header text-center">
                                    <i class="fas fa-globe"></i> PURCHASE REPORT BETWEEN ({{$from}} AND {{$to}}) <br>
                                    @if($dpt != 'All'){
                                       {{$dpt}}
                                    }
                                    @endif
                                    ...
                                    <table class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Supplier</th>
                                                <th>Quantity</th>
                                                <th class="text-end">Uit price</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">@money($value->unit_cost)</td>
                                                <td class="text-end">@php($z=$value->unit_cost*$value->stock_qty)
