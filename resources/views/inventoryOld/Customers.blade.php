                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table-action">
                                                        ...
                                                        <a onclick="return confirm('Are you sure you want to delete?');" href="{{ url('inventory/customers/delete/'.$value->id) }}"  data-toggle="tooltip" title="Delete!" class="action-icon"> <i class="bx bx-trash"></i></a>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="{{ url('inventory/customers/update/'.$value->id) }}" method="POST">
                                                                                @csrf
